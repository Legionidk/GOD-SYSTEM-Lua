require("heistcontrol/util/notify_system.lua")
...
function OnInit()
    ...
    log.init(string.format("[Heist Control by lgn] Инициализация завершена за %s секунд", tostring(os.clock() - startTime):sub(0, 3)))
