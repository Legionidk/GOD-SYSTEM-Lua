...
Main:add_sub_option('Настройка ограбления', 'HC_CayoSettings', CayoSettings)
...
Main:add_click_option('Быстрая настройка ограбления', 'HC_CayoFast', function()
    player_index = script_global:new(1574915):get_int64()
    clear('PAINT', 'COKE', 'WEED', 'CASH')
...
Main:add_click_option('Удалить долю Павла и команды', 'HC_CayoCut', function()
...
Main:add_click_option('Мгновенно завершить', 'HC_CayoInsta', function()
...
Main:add_choose_option('Сбросить кд ограбления', 'HC_CayoCd', false, {'Соло', 'Мульти'}, function(pos)
    player_index = script_global:new(1574915):get_int64()
    if pos == 1 then
