--- Heist Control by lgn v2.1.2 (1.68, 3095) --------------------------
...
if native.is_invoker_ready() then
    ...
    console.log(14, '[Heist Control by lgn] Инвокер не готов, закрытие луа...\n')
    utils.notify('Heist Control by lgn', 'Инвокер не готов, закрытие луа...', 2, 2)
    utils.stop_script()
end
